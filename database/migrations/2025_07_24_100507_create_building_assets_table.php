...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('building_assets', function (Blueprint $table) {
            ...
            $table->string('certificate_owner', 255)->nullable();
            $table->enum('certificate_status', ['SHM', 'HGB', 'other'])->nullable();
            $table->foreignId('certificate_location_id')->constrained('locations')->onDelete('set null');
            $table->string('imb_holder_name', 255)->nullable();
            $table->string('imb_number', 100)->nullable();
            $table->foreignId('imb_location_id')->constrained('locations')->onDelete('set null');
            ...
            $table->foreignId('pbb_location_id')->constrained('locations')->onDelete('set null');
